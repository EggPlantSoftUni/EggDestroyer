...
public class Bonus extends Sprite { // holds the definitions of bonus
	...
	private int ybdir;
	protected String bonus = "../images/bonus.png"; // declares the path of the
													// bonus image
	...
	public Bonus() {
		...
		ImageIcon ii = new ImageIcon(this.getClass().getResource(bonus)); // creates
																			// the
																			// used
																			// icon
																			// for
	...
	{
		x += xbdir; // each time the timer calls the function the x position is
