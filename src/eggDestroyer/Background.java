...
public class Background extends Sprite { // the Background Class
	...
	String background = "../images/mainbg.png"; // creates the path of the used
												// image
	...
	public Background(int x, int y) { // decleration of a background's x and y
		...
		ImageIcon ii = new ImageIcon(this.getClass().getResource(background)); // creates
																				// the
																				// background
																				// image
																				// icon
		...
		ImageIcon ii1 = new ImageIcon(this.getClass().getResource(gameOverBg)); // creates
																				// the
																				// game
																				// over
																				// background
		...
		ImageIcon ii2 = new ImageIcon(this.getClass().getResource(victoryBg)); // creates
																				// the
																				// victory
																				// background
																				// image
		...
		width2 = image2.getWidth(null); // set the width and height of the used
										// image
